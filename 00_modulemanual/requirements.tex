...
\item[Coding style] Use the java coding style as introduced in
  ...
  the project svnroot \url{https://www.fontysvenlo.org/svn/2015/prj32/svnroot/trunk}. To check you style conformance beforehand you
...
\item[Code documentation] All classes and interfaces in the
  ...
  documentation. For package info files use the modern variant
...
\item[Reporting] Write your documentation for the intended
  ...
  Use detailed diagrams only in the appendix. Maybe you could use \textbf{this}
  report (in \LaTeX\ format) as an example. You can find it's sources
  in the project repository \dots\texttt{svnroot/trunk/00\_modulemanual}.
\end{Description}
...
{\sourceroot/src/main/java/nl/fontys/sevenlo/iowarrior/IOWarriorConnector.java}
